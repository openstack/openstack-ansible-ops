...
libvirt-bin lvm2 openssh-server python2.7 qemu-kvm vim virtinst virt-manager vlan zfsutils-linux

# I will have to source my own networking interfaces file.

# There is no point in sourcing everything.
